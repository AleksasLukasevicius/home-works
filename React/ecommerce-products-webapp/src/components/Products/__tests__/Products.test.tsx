...
describe("Products", () => {
  ...
  //jei nepasiekiamas toBeVisible naudoti toBeInTheDocument()

  it("should render Products correctly", () => {
    render(<Products />);

    expect(screen.getByRole("products-container")).toBeVisible();
  });
  ...
  it("should show filtered Products list", async () => {
    ...
    const fetchedProductsCount =
      screen.getByLabelText("products list").childElementCount; // || children.length;
    ...
    const filteredFetchedProductsCount =
      screen.getByLabelText("products list").children.length;

    expect(filteredFetchedProductsCount).toBeLessThan(fetchedProductsCount);
